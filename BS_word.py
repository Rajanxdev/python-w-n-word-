#author ..... Noob-boy (Rajan kumar)
# this is very easy way to make this type code.....
import sys
...
class MainApp(QMainWindow):
    ...
    def create_toolbar(self):
        ...
        # undo
        undo_action = QAction(QIcon("img/undo.png"), 'Undo', self)
        undo_action.triggered.connect(self.editor.undo)
        ToolBar.addAction(undo_action)

        # redo
        redo_action = QAction(QIcon("img/redo.png"), 'Redo', self)
        ...
        # copy
        copy_action = QAction(QIcon("img/copy.png"), 'Copy', self)
        copy_action.triggered.connect(self.editor.copy)
        ToolBar.addAction(copy_action)

        # cut 
        cut_action = QAction(QIcon("img/cut.png"), 'Cut', self)
        cut_action.triggered.connect(self.editor.cut)
        ToolBar.addAction(cut_action)

        # paste
        paste_action = QAction(QIcon("img/paste.png"), 'Paste', self)
        paste_action.triggered.connect(self.editor.paste)
        ...
        # bold
        bold_action = QAction(QIcon("img/bold.png"), 'Bold', self)
        bold_action.triggered.connect(self.bold_text)
        ToolBar.addAction(bold_action)

        # underline
        underline_action = QAction(QIcon("img/underline.png"), 'Underline', self)
        underline_action.triggered.connect(self.underline_text)
        ToolBar.addAction(underline_action)

        # italic
        italic_action = QAction(QIcon("img/italic.png"), 'Italic', self)
        ...
        # text alignment
        right_alignment_action = QAction(QIcon("img/right-align.png"), 'Align Right', self)
        ...
        left_alignment_action = QAction(QIcon("img/left-align.png"), 'Align Left', self)
        ...
        justification_action = QAction(QIcon("img/justification.png"), 'Center/Justify', self)
        ...
        # zoom in
        zoom_in_action = QAction(QIcon("img/zoom-in.png"), 'Zoom in', self)
        zoom_in_action.triggered.connect(self.editor.zoomIn)
        ToolBar.addAction(zoom_in_action)

        # zoom out
        zoom_out_action = QAction(QIcon("img/zoom-out.png"), 'Zoom out', self)
